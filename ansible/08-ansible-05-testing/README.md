...
aragast/netology   latest    b453a84e3f7a   9 months ago   2.46GB
```
## Основная часть
...
4. Добавьте несколько assert в verify.yml-файл для проверки работоспособности vector-role (проверка, что конфиг валидный, проверка успешности запуска и др.). 5. Запустите тестирование роли повторно и проверьте, что оно прошло успешно.
...
[tag 1.1.1](https://github.com/Igor-99/vector-role/releases/tag/1.1.1)
### Tox
